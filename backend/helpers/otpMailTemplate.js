function otpMailTemplate(otp, link) {
  ...
  return `
        <div style="width:360px;padding:20px;background:#e9e9e9;border-radius:5px;margin: 0 auto;">
            ...
            <div>
                ...
                <p style="font-style:italic;color:#555555">If you didn't create an account in KANBAN-Board, please ignore this message.</p><div class="yj6qo"></div><div class="adL">
            </div>
        </div>
    `;
}
