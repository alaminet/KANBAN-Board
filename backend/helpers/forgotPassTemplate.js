  ...
  return `
          <div style="width:360px;padding:20px;background:#e9e9e9;border-radius:5px;margin: 0 auto;">
                  ...
                  <tbody>
                      <tr>
                        ...
                        <td style="text-align: right;">
                            <a href="#m_-9126921749703876496_"><button style="background:#4a4a4a;color:#fff;padding:5px 10px">VISIT</button></a>
                        </td>
                      </tr>
                  </tbody>
              </table>
              <div>
                  ...
                  <p style="margin-bottom:0;font-weight:600">click this button to confirm your email:</p>
                  ...
                  <p style="font-style:italic;color:#555555">If you didn't change your password at KANBAN-Board, please ignore this message.</p><div class="yj6qo"></div><div class="adL">
              </div>
          </div>
      `;
}
